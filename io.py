...
def get_info(fname, fpath=None):
	...
	return filepath, in_num, s_freq, chans, hbsn, start_time
...
def load_eeg(filepath, s_freq, channels, start_time):
...
def read_xltek(fname, fpath=None):
	...
	"""
	filepath, in_num, s_freq, chans, hbsn, start_time = get_info(fname, fpath)
	channels = get_chans(chans, hbsn)
	data = load_eeg(filepath, s_freq, channels, start_time)
